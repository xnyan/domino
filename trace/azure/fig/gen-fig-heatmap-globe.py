...
src_dc_l = ['eastus2', 'westus2', 'francecentral', 'australiaeast', 'eastasia', 'southeastasia']
dst_dc_l = ['eastus2', 'westus2', 'francecentral', 'australiaeast', 'eastasia', 'southeastasia']
for src in src_dc_l:
  for dst in dst_dc_l:
    if dst is src:
      continue
