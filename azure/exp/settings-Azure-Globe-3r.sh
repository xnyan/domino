...
resource_group_name="globe-6dc-3r-exp"
...
cluster_config=(
## Domino Experiment
## Globe settings with 6 datacenters and 3 replicas, which are geo-distributed.
"eastus2            eastus2           10.1.0.0    1"
"westus2            westus2           10.3.0.0    2"
"francecentral      francecentral     10.16.0.0   2"
"southeastasia      southeastasia     10.23.0.0   1"
"eastasia           eastasia          10.22.0.0   1"
"australiaeast      australiaeast     10.28.0.0   2"
)
