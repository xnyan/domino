...
//func (t *ProposeReplyTS) Marshal(wire io.Writer) { // original code
//	var b [8]byte
//	var bs []byte
//	bs = b[:5]
//	bs[0] = byte(t.OK)
...
func (t *ProposeReplyTS) Marshal(wire io.Writer) {  // added by @skoya76
    var b [8]byte
    var bs []byte
    bs = b[:5]
    bs[0] = byte(t.OK)
...
//func (t *ProposeReplyTS) Unmarshal(wire io.Reader) error { // original code
//	var b [8]byte
//	var bs []byte
//	bs = b[:5]
//	if _, err := io.ReadAtLeast(wire, bs, 5); err != nil {
...
func (t *ProposeReplyTS) Unmarshal(wire io.Reader) error { // added by @skoya76
	var b [8]byte
	var bs []byte
	bs = b[:5]
	if _, err := io.ReadAtLeast(wire, bs, 5); err != nil {
